...
function renderSummary(
  ...
  const lines = [
    ...
    '- Patch only the adapter source path shown in front matter unless the user explicitly asks for broader changes.',
    '- Treat auth, captcha, rate limit, and browser connection failures as environment issues, not adapter bugs.',
    '',
    '## Error',
    '',
