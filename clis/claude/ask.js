...
export const askCommand = cli({
    ...
    args: [
        ...
        { name: 'model', default: 'sonnet', choices: ['sonnet', 'opus', 'haiku'], help: 'Switch to sonnet, opus, or haiku before sending. Omit to keep the current selection.' },
    ...
    func: async (page, kwargs) => {
        ...
        // and skip it entirely unless --model was passed explicitly so a bare
        // `ask` doesn't override whatever model the user picked in the UI.
