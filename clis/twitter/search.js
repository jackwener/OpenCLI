...
function tweetToRow(result, seen) {
    ...
    return {
        ...
        author_verified: Boolean(tweetUser?.is_blue_verified || tweetUser?.legacy?.verified),
        bio,
...
cli({
    ...
    columns: ['id', 'author', 'author_verified', 'bio', 'text', 'created_at', 'likes', 'views', 'url', 'has_media', 'media_urls', 'media_posters', 'card', 'quoted_tweet'],
