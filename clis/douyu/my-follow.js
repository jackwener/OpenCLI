...
export const command = cli({
  site: 'douyu',
  name: 'my-follow',
  description: '获取我的斗鱼关注列表',
  access: 'read',
  example: 'opencli douyu my-follow --limit 10 -f yaml',
  ...
  func: async (page, kwargs) => {
    ...
    await page.goto('https://www.douyu.com/directory/myFollow', { waitUntil: 'load', settleMs: 3000 });
    ...
    if (result?.isUnLogin || rows.length === 0) {
      requireDouyuLogin('Douyu login is required to read follow list');
    }
